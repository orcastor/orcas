...
type DataInfo struct {
	...
	HdrXXH3   uint64 `borm:"h" json:"h,omitempty"`   // XXHash3-64bit checksum of first 100KB
	XXH3      uint64 `borm:"x" json:"x,omitempty"`   // XXHash3-64bit checksum of entire original data
	...
	Cksum     uint64 `borm:"c" json:"c,omitempty"`   // Checksum of final data (for consistency audit)
...
func (dma *DefaultMetadataAdapter) RefData(c Ctx, bktID int64, d []*DataInfo) ([]int64, error) {
	...
	var refs []struct {
		...
		HdrXXH3  uint64 `borm:"b.h"`
		XXH3     uint64 `borm:"b.x"`
