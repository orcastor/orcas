...
- `sha256_0`: BIGINT (8 bytes)
- `sha256_1`: BIGINT (8 bytes)
- `sha256_2`: BIGINT (8 bytes)
- `sha256_3`: BIGINT (8 bytes)
- `pkg_id`: BIGINT (8 bytes)
- `pkg_off`: INTEGER (4 bytes)
- `h_xxh3`: BIGINT (8 bytes)
- `xxh3`: BIGINT (8 bytes)
- `cksum`: INTEGER (4 bytes)
- `kind`: SMALLINT (2 bytes)

**每行数据大小**: 8+8+8+8+8+8+8+8+8+4+8+8+4+2 = **98 bytes**
**SQLite行开销**: 约8-12 bytes
**实际每行**: 约 **105-110 bytes**

假设每个对象平均有1个数据块（文件），10万个对象对应10万个数据块：
10万行: 100,000 × 110 = **11.0 MB**
...
**每个索引条目**: 8+8+8+8+8+8+8+6 = **62 bytes**
10万条: 100,000 × 62 = **6.2 MB**
...
对于10万个对象：
- **最小场景**（简单文件）: **约 28-35 MB**
- **典型场景**（带版本）: **约 60-120 MB**
- **复杂场景**（多版本+长文件名）: **约 120-180 MB**
